...
import { Users, TrendingUp, Award, ArrowRight, Building2, GraduationCap, Briefcase } from 'lucide-react';
      ...
      <div className="pt-32 pb-20 px-6 md:px-12 lg:px-24 border-b border-slate-200 dark:border-dark-border bg-white dark:bg-dark-bg">
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto md:mx-0">
            Badan Eksekutif Mahasiswa Fakultas Sains dan Teknologi Universitas 'Aisyiyah Yogyakarta. 
            Wadah aspirasi dan pengembangan diri bagi mahasiswa Teknologi Informasi, Arsitektur, dan Bioteknologi.
          </p>
        </div>
      </div>
